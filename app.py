...
data_co["Revenue"] = (data_co["Order_Item_Product_Price"] * data_co["Order_Item_Quantity"]) - data_co["Order_Item_Discount"]
...
total_shipments = data_co[data_co["shipping_date_DateOrders"].notna()]["Order_Id"].nunique()
...
# --- Chart 3: Orders by Customer Segment ---
